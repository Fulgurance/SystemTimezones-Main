class Target < ISM::Software
    ...
    def prepareInstallation
        ...
        [   "etcetera",
            ...
            runZicCommand(["zic","-L","/dev/null","-d","/usr/share/zoneinfo/",timezone], mainWorkDirectoryPath)
            runZicCommand(["zic","-L","/dev/null","-d","/usr/share/zoneinfo/posix",timezone], mainWorkDirectoryPath)
            runZicCommand(["zic","-L","leapseconds","-d","/usr/share/zoneinfo/right",timezone], mainWorkDirectoryPath)
        end
        ...
        runZicCommand(["zic","-d","/usr/share/zoneinfo","-p","America/New_York"], mainWorkDirectoryPath)
    end
